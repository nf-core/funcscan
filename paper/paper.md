...
nf-core/funcscan has an active user community of scientific users and developers on the public nf-core Slack and GitHub ([https://nf-co.re/join](https://nf-co.re/join)).
