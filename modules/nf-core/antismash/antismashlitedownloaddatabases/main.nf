process ANTISMASH_ANTISMASHLITEDOWNLOADDATABASES {
    ...
    */
    ...
    cp_cmd = workflow.containerEngine == null ? "cp -r \$(python -c 'import antismash;print(antismash.__file__.split(\"/__\")[0])') antismash_dir;" : "cp -r /usr/local/lib/python3.8/site-packages/antismash antismash_dir;"
    """
