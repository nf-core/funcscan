...
- [#274](https://github.com/nf-core/funcscan/pull/274) Update all modules: changed docker links according to the change of quay.io as default repository and updated funcscan.nf with the now zipped output of Pyrodigal. (by @jasmezz)
