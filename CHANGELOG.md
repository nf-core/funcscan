...
- [#366](https://github.com/nf-core/funcscan/pull/366) Added nf-test on pipeline level; skip hmmmsearch by default to not crash pipeline if user provides no HMM files. (by @jfy133, @jasmezz)
