...
- [#299](https://github.com/nf-core/funcscan/pull/299) Fixed pigz error with symlinks in Pyrodigal, updated other modules: comBGC, FastQC, GECCO, gunzip, untar. (by @jasmezz)
