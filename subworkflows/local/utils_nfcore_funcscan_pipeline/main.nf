...
def toolBibliographyText() {
    ...
    def arg_text           = [
            ...
            !params.arg_skip_argnorm       ? "<li> Perovic, S. U., Ramji, V., Chong, H., Duan, Y., Maguire, F., Coelho, L. P. (2024). argNorm. Github <a href=\"https://github.com/BigDataBiology/argNorm\"https://github.com/BigDataBiology/argnorm</a>. DOI:<a href=\"https://zenodo.org/doi/10.5281/zenodo.10963591\" 10.5281/zenodo.10963591</a>.</li>" : "",
