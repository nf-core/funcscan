...
- [AMPcombi](#ampcombi) – summary and report of antimicrobial peptide gene output from various detection tools.
...
- `ampcombi/`
  ...
  - `<sample>/contig_gbks`: contains all the contigsin gbk format that an AMP was found on using the custom parameters
