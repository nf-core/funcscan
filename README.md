...
1. Annotates prokaryotic input assembled contigs ([`Prodigal`](https://github.com/hyattpd/Prodigal), [`PROKKA`](https://github.com/tseemann/prokka), or [Bakta](https://github.com/oschwengers/bakta))
