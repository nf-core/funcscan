# ![nf-core/sarek](docs/images/nf-core-funcscan_logo_light.png#gh-light-mode-only) ![nf-core/sarek](docs/images/nf-core-funcscan_logo_dark.png#gh-dark-mode-only)
...
3. Download the pipeline and test it on a minimal dataset with a single command:
    ...
    ```console
    nextflow run nf-core/funcscan -profile test,YOURPROFILE
    ```
