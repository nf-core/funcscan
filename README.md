...
5. Creates aggregated reports for all samples across the workflows with [AMPcombi](https://github.com/Darcy220606/AMPcombi) for AMPs, [hAMRonization](https://github.com/pha4ge/hAMRonization) for ARGs, and comBGC for BGCs.
